...
document.getElementById("openApprovalModalButton").addEventListener("click", (event) => {
    openApproveDonationModal();
});

function openApproveDonationModal() {
    // Show the modal
...
function closeApproveDonationModal() {
    // Hide the modal
